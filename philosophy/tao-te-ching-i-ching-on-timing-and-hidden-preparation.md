---
title: "Tao Te Ching + I Ching on Timing and Hidden Preparation"
date: 2026-04-21
captured: 2026-04-21T00:50:47.370Z
tags: ["taoism", "i-ching", "wu-wei", "timing", "vietnamese", "tao-te-ching"]
source: "Facebook share from a friend, curated Tao Te Ching + I Ching passages in Vietnamese translation"
---
# Tao Te Ching + I Ching on Timing and Hidden Preparation

Curated passages from a friend's morning share. Loosely translated from English (likely Stephen Mitchell) Tao Te Ching + one I Ching hexagram. The selection itself is the argument: **when to act, when to wait, and what waiting actually means**.
...
| Passage | Source |
|---|---|
| "Bạn có lòng kiên nhẫn... bùn lắng, nước trong" | Tao Te Ching Ch. 15 |
| "Người đứng trên mũi chân..." | Ch. 24 |
| "Có lúc tiến, có lúc lùi..." | Ch. 29 |
| "Tiềm long vật dụng" (潛龍勿用) | I Ching, Qian hexagram 乾卦, line 1 + Wenyan commentary |
| "Người hiểu đạo... ví dụ sống" | Ch. 22 |
| "Người hiểu đạo hành sự bằng cách để sự tự hành" | Ch. 64 |
| "Người biết sợ cái đáng sợ" | Ch. 72 |
...
High virtue but hidden. When the world changes, the self does not. When the time comes, act on the Way. When the time is wrong, conceal the Way along with yourself.

## The Key Insight (Original to the Poster)

Most readings of 無為 (wu wei) get interpreted as passivity. The post corrects this:
...
The framework is useful for anyone navigating:
- Long-horizon projects with uncertain launch timing
- Building reputation vs. building capability
- The tension between visibility and substance
- Deciding between public work and deep preparation phases

The Taoist answer is clear: **substance first, visibility on time, not before.**

## Honest Caveats

- The translations are Mitchell-style poetic, not scholarly literal. "What he learns is to unlearn" is liberty, not Laozi.
- Ch. 24 appears twice in the source post (likely a copy-paste error, not emphasis).
- The mix of Tao Te Ching and I Ching works here because both wrestle with the same question: **when to act**. But they come from different traditions and shouldn't be conflated casually.
