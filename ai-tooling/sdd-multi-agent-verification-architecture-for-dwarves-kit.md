...
date: 2026-03-29
captured: 2026-03-29T11:00:42.813Z
...
![SDD multi-agent topology showing 5 phases: Think, Spec, Build, Review, Ship with verification agents and retry loops at each boundary](../assets/ai-tooling/sdd-multi-agent-topology.svg)
...
![Three implementation phases: verification pipeline (this week), bootstrap + routing (next week), parallel + coordination (month 2+)](../assets/ai-tooling/sdd-implementation-phases.svg)
