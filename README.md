...
> Auto-generated index of 59 note(s). Last updated: 2026-04-08
...
- [Llm memory systems three competitive battlegrounds](ai/llm-memory-systems-three-competitive-battlegrounds.md)
...
- [Claude code ecosystem repo evaluations for kit building](claude-code/claude-code-ecosystem-repo-evaluations-for-kit-building.md)
- [Claude code hook lifecycle and event system](claude-code/claude-code-hook-lifecycle-and-event-system.md)
...
- [Four asian diasporas 30 year projection](diaspora/four-asian-diasporas-30-year-projection.md)
...
- [Vietnamese vs chinese diaspora why one builds economic hubs and the other doesnt](diaspora/vietnamese-vs-chinese-diaspora-why-one-builds-economic-hubs-and-the-other-doesnt.md)
...
- [Mcp tool schema caching in claude ai connectors](mcp/mcp-tool-schema-caching-in-claude-ai-connectors.md)
- [Security gates for mcp tools that bridge private to public](mcp/security-gates-for-mcp-tools-that-bridge-private-to-public.md)

## patterns

- [Redundant api pre checks in wrapper functions](patterns/redundant-api-pre-checks-in-wrapper-functions.md)

## pkm

- [Why knowledge notes need context not just facts](pkm/why-knowledge-notes-need-context-not-just-facts.md)

## predictive-history

- [Predictive history and the ambition of psycho history](predictive-history/predictive-history-and-the-ambition-of-psycho-history.md)
...
- [Youtube transcript extraction from cloud containers](youtube/youtube-transcript-extraction-from-cloud-containers.md)
