...
- [[dwarves-kit-v1-2-verification-pipeline-architecture]] - the verification pipeline that resolved the execution engine decision
- [[code-graph-context-tools-for-token-reduction]] - detailed evaluation of codebase-memory-mcp adopted in decision #3
- [[dwarves-kit-design-philosophy-and-architecture]] - the principles that guided each decision