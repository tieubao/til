...
**Dequantization (2018).** Ewin Tang, an 18-year-old undergraduate at UT Austin, discovered that under the same access assumptions HHL requires, a *classical* algorithm achieves the same complexity. Scott Aaronson had given Tang the recommendation-systems variant of HHL as a thesis topic, expecting it would prove the quantum advantage. Tang proved the opposite — that the speedup was an artifact of the unrealistic assumptions, not the quantum hardware.
